...
module.exports = {
  init: function () {
    ...
    $('.layout.accordion.tabs .tab-link').on('click', function (evt) {
      ...
      var accItems = this.closest('.layout.accordion.tabs').querySelectorAll('.acc-item'); // Remove active class from all selected tabs, accordion groups, nav item, and accordion item
      ...
      index -= 1; // console.log('Accordion index: ' + index);
...
module.exports = {
  init: function () {
    var headerHeight = 0; // Link is on the same page
...
module.exports = {
  init: function () {
    ...
    }, 250); // Set timeout on all SVG elements below to give them time to load
...
},{"animejs":2,"aos":3,"jquery":4}],9:[function(require,module,exports){
var $ = require('jquery');
    ...
    if (images.length > 0) {
      for (var i = 0; i < images.length; i++) {
        ...
        var galleryAnimation = function () {
          ...
          var lastIndex = slideCount - 1; // console.log(i);
          ...
          if (i == 0) {
            ...
            var third = 0; // } else if ( i == lastIndex - 1 ) {
            // 	var first = i - 1;
            // 	var second = lastIndex;
            // 	var third = 0;
          } else {
          ...
          var secondSlide = '.slide-' + second + ' img';
          var thirdSlide = '.slide-' + third + ' img'; // All slides
...
},{"@glidejs/glide":1,"animejs":2,"jquery":4}],12:[function(require,module,exports){
var $ = require('jquery');
...
module.exports = {
  init: function () {// Commenting out vue since it is not used on this site.
    // var app = new Vue({
    // 	el: '#app',
    // 	data: {
  ...
  init: function () {
    ...
    $('img.svg').each(function () {
      ...
      $.get(imgURL, function (data) {
        ...
        $svg = $svg.removeAttr('xmlns:a'); // Add property for IE svg sizing

        $svg = $svg.attr('preserveAspectRatio', 'xMinYMin meet'); // Replace image with new SVG
...
var AOS = require('aos'); // var polyfill = require('./modules/polyfill-modal.js'); // polyfill for micromodal
...
},{"./modules/accordions.js":6,"./modules/anchors.js":7,"./modules/animate.js":8,"./modules/buttons.js":9,"./modules/fancylabels.js":10,"./modules/glide.js":11,"./modules/load-more.js":12,"./modules/menu.js":13,"./modules/style-guide.js":14,"./modules/svg.js":15,"aos":3,"jquery":4,"micromodal":5}]},{},[16])
